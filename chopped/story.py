...
BEATS = {
    ...
    "blue_lights.start": [
        ...
        ("TOMMY", "STOP ONE -- SPIKES, A ROADBLOCK, A BOX OF DONUTS -- AND DRAG THE OFFICER OUT. BRING IT TO "
                  "YOUR SHOP."),
        ("TOMMY", "OR LET HIM JUMP OUT TO CHASE YOU ON FOOT, AND JUMP IN. HE'LL BE SO CROSS."),
    ],
    "blue_lights.end": [
